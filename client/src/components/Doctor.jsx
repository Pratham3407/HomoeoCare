      ...
      <div className="doctor-container">
        ...
        <div className="doctor-right">
          ...
          <div style={{ display: "flex", gap: "10px", marginTop: "20px", flexWrap: "wrap" }}>
            {/* Desktop Call button (shown on larger screens) */}
            <a href="tel:+919824011536" className="desktop-call-btn" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "10px 20px", background: "#6f8f7b", color: "white", textDecoration: "none", borderRadius: "50px", fontWeight: "600", fontSize: "14px", transition: "transform 0.2s" }} onMouseOver={e => e.currentTarget.style.transform = "scale(1.05)"} onMouseOut={e => e.currentTarget.style.transform = "scale(1)"}>
